(function (vue) {
  ...
  const _imports_0$6 = "/static/启动页闪屏.png";

  const _imports_1$3 = "/static/landingB.png";
  ...
  const PagesLandingLanding = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["render", _sfc_render$g], ["styles", [_style_0$h]]]);
  ...
  const _sfc_main$g = vue.defineComponent({
      ...
      onLoad(options = null) {
          ...
          uni.__log__('log', 'at pages/preference/preference.uvue:44', 'User ID:', this.userId);
          uni.__log__('log', 'at pages/preference/preference.uvue:45', 'Username:', this.username);
      },
      methods: {
  ...
  const _style_0$g = {"container":{"":{"display":"flex","flexDirection":"column","backgroundColor":"#1c1c1e","paddingTop":40,"paddingRight":20,"paddingBottom":40,"paddingLeft":20}},"content":{"":{"flex":1,"display":"flex","flexDirection":"column","justifyContent":"space-between"}},"text-content":{"":{"marginBottom":110}},"question":{"":{"fontSize":24,"color":"#ffffff","marginBottom":8}},"subtitle":{"":{"fontSize":14,"color":"#8e8e93"}},"gender-options":{"":{"display":"flex","flexDirection":"row","justifyContent":"space-between","marginTop":40}},"gender-option":{"":{"width":"30%","aspectRatio":1,"backgroundColor":"#2c2c2e","borderRadius":10,"display":"flex","flexDirection":"column","justifyContent":"center","alignItems":"center","borderWidth":2,"borderStyle":"solid","borderColor":"rgba(0,0,0,0)"},".selected":{"borderColor":"#30d158"}},"gender-icon":{"":{"fontSize":24,"color":"#ffffff","marginBottom":5}},"gender-label":{"":{"fontSize":14,"color":"#ffffff"}},"continue-button":{"":{"width":50,"height":50,"top":200,"backgroundColor":"#30d158","borderRadius":25,"display":"flex","justifyContent":"center","alignItems":"center","alignSelf":"center","marginTop":"auto","marginBottom":600}},"arrow":{"":{"color":"#ffffff","fontSize":20}}};
      ...
      vue.createElementVNode("view", { class: "content" }, [
        ...
        vue.createElementVNode("view", { class: "gender-options" }, [
          vue.createElementVNode("view", {
            ...
            onClick: _cache[0] || (_cache[0] = ($event) => $options.selectGender("male"))
          }, [
          ...
          vue.createElementVNode("view", {
            ...
            onClick: _cache[1] || (_cache[1] = ($event) => $options.selectGender("female"))
          }, [
            vue.createElementVNode("text", { class: "gender-icon" }, "\u2640"),
  ...
  const PagesPreferencePreference = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["render", _sfc_render$f], ["styles", [_style_0$g]]]);

  const _sfc_main$f = vue.defineComponent({
      data() {
          return {
              months: ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'],
              days: Array.from({ length: 31 }, (_ = null, i) => { return i + 1; }),
              years: Array.from({ length: 50 }, (_ = null, i) => { return 2024 - i; }),
              dateValue: [8, 16, 5],
              indicatorStyle: 'height: 50px; border-top: 1px solid rgba(255, 255, 255, 0.1); border-bottom: 1px solid rgba(255, 255, 255, 0.1);',
              userId: '',
              username: '',
              gender: '',
          };
      ...
      onLoad(options = null) {
          ...
          uni.__log__('log', 'at pages/preference/preference1.uvue:56', 'Received data:', { userId: this.userId, username: this.username, gender: this.gender });
      },
      methods: {
          onDateChange(e = null) {
  ...
  const _style_0$f = {"container":{"":{"display":"flex","flexDirection":"column","backgroundColor":"#1c1c1e","paddingTop":40,"paddingRight":20,"paddingBottom":40,"paddingLeft":20}},"content":{"":{"flex":1,"display":"flex","flexDirection":"column","justifyContent":"space-between"}},"text-content":{"":{"marginBottom":40}},"question":{"":{"fontSize":24,"color":"#ffffff","marginBottom":8}},"subtitle":{"":{"fontSize":14,"color":"#8e8e93"}},"date-picker-container":{"":{"flex":1,"display":"flex","justifyContent":"center","alignItems":"center","position":"relative","overflow":"hidden"}},"date-picker":{"":{"width":"100%","height":250}},"picker-item":{"":{"lineHeight":"50px","textAlign":"center","color":"rgba(0,0,0,0.3)","transitionProperty":"color","transitionDuration":"0.3s"},".active":{"color":"#8e8e93","fontWeight":"bold"}},"mask":{"":{"position":"absolute","left":0,"right":0,"height":100,"backgroundColor":"#1c1c1e","zIndex":1},".top":{"top":0},".bottom":{"bottom":0}},"continue-button":{"":{"width":50,"height":50,"top":200,"backgroundColor":"#30d158","borderRadius":25,"display":"flex","justifyContent":"center","alignItems":"center","alignSelf":"center","marginBottom":480}},"arrow":{"":{"color":"#ffffff","fontSize":20}},"uni-picker-view-indicator":{"":{"backgroundColor":"rgba(255,255,255,0.1)"}},"uni-picker-view-mask":{"":{"backgroundImage":"linear-gradient(180deg, rgba(28, 28, 30, 0.9), rgba(28, 28, 30, 0.4)),\n                    linear-gradient(0deg, rgba(28, 28, 30, 0.9), rgba(28, 28, 30, 0.4))"}},"@TRANSITION":{"picker-item":{"property":"color","duration":"0.3s"}}};
  ...
  function _sfc_render$e(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
      vue.createElementVNode("view", { class: "content" }, [
        vue.createElementVNode("view", { class: "text-content" }, [
          vue.createElementVNode("text", { class: "question" }, "\u{1F451}\u4F60\u7684\u751F\u65E5\u662F\u4EC0\u4E48\u65F6\u5019\uFF1F"),
          vue.createElementVNode("text", { class: "subtitle" }, "\u5B8C\u5584\u4E2A\u4EBA\u4FE1\u606F")
        ]),
        vue.createElementVNode("view", { class: "date-picker-container" }, [
          ...
          vue.createVNode(_component_picker_view, {
            ...
            default: vue.withCtx(() => [
              vue.createVNode(_component_picker_view_column, null, {
                default: vue.withCtx(() => [
                  (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($data.months, (month, index) => {
                    return vue.openBlock(), vue.createElementBlock("view", {
                      class: vue.normalizeClass(["picker-item", { "active": index === $data.dateValue[0] }]),
                      key: month
                    }, vue.toDisplayString(month), 3);
                  }), 128))
                ]),
                _: 1
              }),
              vue.createVNode(_component_picker_view_column, null, {
                default: vue.withCtx(() => [
                  (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($data.days, (day, index) => {
                    return vue.openBlock(), vue.createElementBlock("view", {
                      class: vue.normalizeClass(["picker-item", { "active": index === $data.dateValue[1] }]),
                      key: day
              ...
              vue.createVNode(_component_picker_view_column, null, {
                default: vue.withCtx(() => [
                  (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($data.years, (year, index) => {
                    return vue.openBlock(), vue.createElementBlock("view", {
                      class: vue.normalizeClass(["picker-item", { "active": index === $data.dateValue[2] }]),
                      key: year
                    }, vue.toDisplayString(year), 3);
                  }), 128))
                ]),
                _: 1
              })
  ...
  const PagesPreferencePreference1 = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["render", _sfc_render$e], ["styles", [_style_0$f]]]);
  ...
  const _sfc_main$e = vue.defineComponent({
      ...
      onLoad(options = null) {
          ...
          uni.__log__('log', 'at pages/preference/preference2.uvue:65', 'Received data:', { userId: this.userId, username: this.username, gender: this.gender, birthday: this.birthday });
      },
      methods: {
          toggleOption(option = null) {
              ...
              uni.__log__('log', 'at pages/preference/preference2.uvue:75', 'Selected options:', this.selectedOptions);
          },
          goToNextPage() {
              if (this.selectedOptions.length > 0) {
                  ...
                  uni.__log__('log', 'at pages/preference/preference2.uvue:82', 'Navigating to:', url);
                  uni.navigateTo({
                      url: url,
                      fail: (err) => {
                          uni.__log__('error', 'at pages/preference/preference2.uvue:86', 'Navigation failed:', err);
                          uni.showToast({
                              title: '页面跳转失败',
                              icon: 'none'
                          });
                  ...
                  uni.__log__('log', 'at pages/preference/preference2.uvue:94', 'No options selected');
                  uni.showToast({
                      title: '请至少选择一个选项',
                      icon: 'none'
                  });
  ...
  const _imports_1$2 = "/static/relationshipicon.png";

  const _style_0$e = {"container":{"":{"display":"flex","flexDirection":"column","backgroundColor":"#1c1c1e","paddingTop":40,"paddingRight":20,"paddingBottom":80,"paddingLeft":20}},"content":{"":{"flex":1,"display":"flex","flexDirection":"column","justifyContent":"space-between"}},"text-content":{"":{"marginBottom":-20}},"question":{"":{"fontSize":18,"color":"#ffffff","marginBottom":8}},"subtitle":{"":{"fontSize":14,"color":"#8e8e93"}},"options-container":{"":{"marginTop":-40,"width":"100%","marginBottom":500,"top":200}},"option-group":{"":{"display":"flex","alignItems":"flex-start","marginBottom":0}},"option-group1":{"":{"top":-140,"display":"flex","alignItems":"flex-start","marginBottom":15}},"group-icon":{"":{"width":36,"height":36,"marginTop":15,"marginRight":15,"flexShrink":0,"marginBottom":0}},"option-buttons":{"":{"display":"flex","flexDirection":"column","alignItems":"flex-start","gap":"5px","left":50,"top":-40,"width":"100%"}},"option-button":{"":{"backgroundColor":"#2c2c2e","color":"#ffffff","borderWidth":"medium","borderStyle":"none","borderColor":"#000000","borderRadius":20,"paddingTop":5,"paddingRight":15,"paddingBottom":5,"paddingLeft":15,"fontSize":14,"textAlign":"left","whiteSpace":"nowrap","marginBottom":5},".active":{"backgroundColor":"#30d158"}},"button-1":{"":{"position":"relative","left":0,"top":0}},"button-2":{"":{"position":"relative","left":140,"top":-55}},"button-3":{"":{"position":"relative","left":0,"top":-55}},"button-4":{"":{"position":"relative","left":160,"top":-110}},"button-5":{"":{"position":"relative","left":0,"top":-110}},"button-6":{"":{"position":"relative","left":0,"top":-110}},"continue-button":{"":{"width":50,"height":50,"backgroundColor":"#30d158","borderRadius":25,"display":"flex","justifyContent":"center","alignItems":"center","alignSelf":"center","marginTop":-360,"position":"relative","zIndex":1}},"arrow":{"":{"color":"#ffffff","fontSize":20}},"colleague-button":{"":{"position":"relative","left":140,"top":-55}},"button-7":{"":{"position":"relative","left":0,"top":0}},"button-8":{"":{"position":"relative","left":150,"top":-55}},"button-9":{"":{"position":"relative","left":0,"top":-55}},"button-10":{"":{"position":"relative","left":150,"top":-110}},"button-11":{"":{"position":"relative","left":10,"top":5}},"button-12":{"":{"position":"relative","left":60,"top":0}}};
        ...
        vue.createElementVNode("view", { class: "options-container" }, [
          vue.createElementVNode("view", { class: "option-group" }, [
            ...
            vue.createElementVNode("view", { class: "option-buttons" }, [
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($data.jobOptions, (option, index) => {
          ...
          vue.createElementVNode("view", { class: "option-group1" }, [
            ...
            vue.createElementVNode("view", { class: "option-buttons" }, [
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($data.relationshipOptions, (option, index) => {
                return vue.openBlock(), vue.createElementBlock("button", {
                  key: index,
  ...
  const PagesPreferencePreference2 = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["render", _sfc_render$d], ["styles", [_style_0$e]]]);
  ...
  const _sfc_main$d = vue.defineComponent({
      ...
      onLoad(options = null) {
          uni.__log__('log', 'at pages/preference/preference3.uvue:44', 'Raw options received in preference3:', options);
          this.userId = options.userId || '';
          this.username = decodeURIComponent(options.username || '');
          this.gender = options.gender || '';
          uni.__log__('log', 'at pages/preference/preference3.uvue:50', 'Parsed basic data in preference3:', {
              userId: this.userId,
          ...
          try {
              ...
              uni.__log__('log', 'at pages/preference/preference3.uvue:59', 'Parsed birthday in preference3:', this.birthday);
          }
          catch (e) {
              uni.__log__('error', 'at pages/preference/preference3.uvue:61', 'Error parsing birthday in preference3:', e);
              uni.__log__('log', 'at pages/preference/preference3.uvue:62', 'Raw birthday data in preference3:', options.birthday);
              this.birthday = null;
          }
          // 解析 selectedOptions
          try {
              const parsedOptions = options.options ? UTS.JSON.parse(decodeURIComponent(options.options)) : [];
              uni.__log__('log', 'at pages/preference/preference3.uvue:69', 'Parsed options:', parsedOptions);
              // 使用显式类型赋值，避免类型错误
              this.selectedOptions = Array.isArray(parsedOptions) ? parsedOptions : [];
              uni.__log__('log', 'at pages/preference/preference3.uvue:74', 'Assigned selectedOptions:', this.selectedOptions);
              uni.__log__('log', 'at pages/preference/preference3.uvue:75', 'selectedOptions length:', this.selectedOptions.length);
              uni.__log__('log', 'at pages/preference/preference3.uvue:76', 'selectedOptions contents:', UTS.JSON.stringify(this.selectedOptions));
          }
          catch (e) {
              uni.__log__('error', 'at pages/preference/preference3.uvue:78', 'Error parsing selectedOptions in preference3:', e);
              uni.__log__('log', 'at pages/preference/preference3.uvue:79', 'Raw options data in preference3:', options.options);
              this.selectedOptions = [];
          }
          // 打印最终的数据状态
          // uni.__log__('log','at pages/preference/preference3.uvue:84','Final data state in preference3:', {
          //   userId: this.userId,
          //   username: this.username,
          //   gender: this.gender,
          ...
          if (!this.userId || !this.username || !this.gender || !this.birthday || this.selectedOptions.length === 0) {
              uni.__log__('error', 'at pages/preference/preference3.uvue:93', 'Some required data is missing or invalid in preference3');
          }
      },
      methods: {
          startTest() {
              uni.__log__('log', 'at pages/preference/preference3.uvue:98', 'Start test button clicked');
          ...
          navigateToNextPage() {
              ...
              uni.__log__('log', 'at pages/preference/preference3.uvue:104', 'Navigating to:', testPageUrl);
              uni.navigateTo({
                  url: testPageUrl,
                  success: () => {
                      uni.__log__('log', 'at pages/preference/preference3.uvue:109', 'Navigation to test page successful');
                  },
                  fail: (err) => {
                      uni.__log__('error', 'at pages/preference/preference3.uvue:112', 'Navigation to test page failed:', err);
                      uni.showToast({
                          title: '页面跳转失败',
                          icon: 'none'
                      });
  ...
  const _style_0$d = {"container":{"":{"display":"flex","flexDirection":"column","backgroundColor":"#1c1c1e","paddingTop":40,"paddingRight":20,"paddingBottom":40,"paddingLeft":20}},"content":{"":{"flex":1,"display":"flex","flexDirection":"column","justifyContent":"space-between","marginBottom":340}},"text-content":{"":{"marginBottom":340}},"question":{"":{"fontSize":20,"color":"#ffffff","marginBottom":8}},"subtitle":{"":{"fontSize":16,"color":"#8e8e93"}},"card":{"":{"backgroundColor":"#1c1c1e","borderRadius":20,"top":-150,"overflow":"hidden"}},"card-image":{"":{"width":"100%","height":250}},"start-button":{"":{"position":"absolute","left":"50%","bottom":180,"transform":"translateX(-50%)","backgroundColor":"#1c1c1e","color":"#ffffff","borderWidth":"medium","borderStyle":"none","borderColor":"#000000","borderRadius":20,"paddingTop":3,"paddingRight":20,"paddingBottom":3,"paddingLeft":20,"fontSize":14}},"arrow":{"":{"marginLeft":2}},"welcome":{"":{"fontSize":18,"color":"#ffffff","marginBottom":8}},"debug-info":{"":{"marginTop":20,"paddingTop":10,"paddingRight":10,"paddingBottom":10,"paddingLeft":10,"backgroundColor":"#2c2c2e","borderRadius":10}}};

  function _sfc_render$c(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
      vue.createElementVNode("view", { class: "content" }, [
        vue.createElementVNode("view", { class: "text-content" }, [
          vue.createElementVNode("text", { class: "question" }, vue.toDisplayString(_ctx.scenarioText || "\u5C0F\u767D\uFF1F\u9AD8\u624B\uFF1F\u4F60\u7684\u60C5\u5546\u5728\u804C\u573A\u4E2D\u5C5E\u4E8E\u54EA\u4E00\u4E2A\u6BB5\u4F4D\u5462\uFF1F"), 1),
          vue.createElementVNode("text", { class: "subtitle" }, "\u4E2A\u6027\u5316\u504F\u597D")
        ]),
  ...
  const PagesPreferencePreference3 = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$c], ["styles", [_style_0$d]]]);
  ...
  const _sfc_main$c = vue.defineComponent({
      ...
      onLoad(option = null) {
          uni.__log__('log', 'at pages/test/test.uvue:43', 'Received options:', option);
          // 接收上一个页面传递的数据
          ...
          if (option.options) {
              try {
                  ...
                  uni.__log__('error', 'at pages/test/test.uvue:54', 'Error parsing options:', e);
                  this.selectedOptions = [];
              }
          }
          if (option.birthday) {
              try {
                  ...
                  uni.__log__('error', 'at pages/test/test.uvue:63', 'Error parsing birthday:', e);
                  this.birthday = null;
              }
          }
          uni.__log__('log', 'at pages/test/test.uvue:68', 'Parsed data:', {
              userId: this.userId,
              username: this.username,
              gender: this.gender,
              selectedOptions: this.selectedOptions,
      ...
      methods: {
          ...
          sendDataToBackend() {
              uni.request({
                  ...
                  success: (res) => {
                      uni.__log__('log', 'at pages/test/test.uvue:98', 'Backend response:', res.data);
                      this.jobId = res.data.job_id; // 存储返回的 job_id
                      // 获取 job_id 后立即调用 start_scenario
                      this.getScenarioData();
                  },
                  fail: (err) => {
                      uni.__log__('error', 'at pages/test/test.uvue:105', 'Error sending data to backend:', err);
                  }
              });
          },
          getScenarioData() {
              uni.request({
                  ...
                  success: (res) => {
                      try {
                          ...
                          uni.__log__('log', 'at pages/test/test.uvue:116', 'Scenario data:', data);
                          this.scenarioData = data.scenes || null;
                          this.handleScenarioData();
                      }
                      catch (error) {
                          uni.__log__('error', 'at pages/test/test.uvue:120', 'Error parsing scenario data:', error);
                          this.background = '获取场景数据时出错。';
                      }
                  },
                  fail: (err) => {
                      uni.__log__('error', 'at pages/test/test.uvue:125', 'Error getting scenario data:', err);
  ...
  const _style_0$c = {"container":{"":{"position":"relative","width":"100%","height":"100%"}},"background-image":{"":{"position":"absolute","top":0,"left":0,"width":"100%","height":"100%"}},"room-info":{"":{"position":"absolute","top":"80rpx","left":"50%","transform":"translateX(-50%)","backgroundColor":"rgba(55,55,66,0.4)","borderRadius":"40rpx","paddingTop":"24rpx","paddingRight":"20rpx","paddingBottom":"24rpx","paddingLeft":"20rpx","width":"280rpx","boxSizing":"border-box"}},"room-text":{"":{"color":"#F6ECC9","fontSize":"32rpx","textAlign":"right","paddingRight":"20rpx"}},"gray-circle":{"":{"position":"absolute","width":"70rpx","height":"70rpx","backgroundColor":"#373742","top":"122rpx","left":"260rpx","transform":"translate(-50%, -50%)","display":"flex","justifyContent":"center","alignItems":"center"}},"logo":{"":{"width":"40rpx","height":"40rpx"}},"text-box":{"":{"position":"absolute","bottom":"80rpx","left":"40rpx","right":"40rpx","backgroundColor":"rgba(55,55,66,0.8)","borderRadius":"50rpx","paddingTop":"50rpx","paddingBottom":"30rpx","paddingLeft":"50rpx","paddingRight":"50rpx","zIndex":1,"minHeight":"100rpx","maxHeight":"400rpx"}},"text-content":{"":{"color":"#FFFFFF","fontSize":"28rpx","lineHeight":1.4}},"expand-icon":{"":{"textAlign":"center","color":"#FFFFFF","fontSize":"24rpx","marginTop":"10rpx"}},"debug-info":{"":{"position":"absolute","top":0,"left":0,"right":0,"backgroundColor":"rgba(0,0,0,0.5)","color":"#FFFFFF","paddingTop":"10rpx","paddingRight":"10rpx","paddingBottom":"10rpx","paddingLeft":"10rpx","fontSize":"20rpx","zIndex":100,"overflowY":"auto"}}};
  ...
  function _sfc_render$b(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
      ...
      vue.createElementVNode("view", { class: "text-box" }, [
        vue.createElementVNode("text", { class: "text-content" }, vue.toDisplayString($data.background), 1),
        vue.createElementVNode("view", {
          class: "expand-icon",
  ...
  const PagesTestTest = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$b], ["styles", [_style_0$c]]]);
  ...
  const _sfc_main$b = vue.defineComponent({
      ...
      onLoad(option = null) {
          uni.__log__('log', 'at pages/test/test1.uvue:54', 'Received options:', option);
          // 接收上一个页面传递的数据
          this.userId = option.userId || '';
          this.username = decodeURIComponent(option.username || '');
          this.gender = option.gender || '';
          ...
          if (option.options) {
              try {
                  ...
                  uni.__log__('error', 'at pages/test/test1.uvue:66', 'Error parsing options:', e);
                  this.selectedOptions = [];
              }
          }
          if (option.birthday) {
              try {
                  ...
                  uni.__log__('error', 'at pages/test/test1.uvue:75', 'Error parsing birthday:', e);
                  this.birthday = null;
              }
          }
          uni.__log__('log', 'at pages/test/test1.uvue:80', 'Parsed data:', {
              userId: this.userId,
              username: this.username,
              gender: this.gender,
              selectedOptions: this.selectedOptions,
      ...
      methods: {
          ...
          getScenarioData() {
              uni.request({
                  ...
                  method: 'POST',
                  success: (res) => {
                      uni.__log__('log', 'at pages/test/test1.uvue:110', 'Scenario data:', res.data);
                      this.scenarioData = res.data; // 修改为直接获取 res.data
                      this.handleScenarioData();
                  },
                  fail: (err) => {
                      uni.__log__('error', 'at pages/test/test1.uvue:115', 'Error getting scenario data:', err);
                  }
              });
          },
          handleScenarioData() {
              if (this.scenarioData) {
                  ...
                  uni.__log__('warn', 'at pages/test/test1.uvue:124', 'Background information not found in scenario data');
  ...
  function _sfc_render$a(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
      ...
      vue.createElementVNode("view", { class: "text-box" }, [
        vue.createElementVNode("text", { class: "text-content" }, vue.toDisplayString($data.description), 1),
        vue.createElementVNode("view", {
          class: "expand-icon",
          onClick: _cache[0] || (_cache[0] = (...args) => $options.navigateToTest1 && $options.navigateToTest1(...args))
        }, "\u25BC")
  ...
  const PagesTestTest1 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$a], ["styles", [_style_0$b]]]);
  ...
  function _sfc_render$9(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
      ...
      vue.createElementVNode("view", { class: "options-container" }, [
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($data.scenarioData && $data.scenarioData.options ? $data.scenarioData.options : [], (option, index) => {
          return vue.openBlock(), vue.createElementBlock("view", {
            key: index,
            class: vue.normalizeClass(["text-box", { "selected": $data.selectedOptionIndex === index }]),
            onClick: ($event) => $options.selectOption(index)
          }, [
            vue.createElementVNode("text", { class: "text-content" }, vue.toDisplayString(option.text), 1)
          ], 10, ["onClick"]);
        }), 128))
      ]),
      vue.createElementVNode("view", {
  ...
  const PagesTestTest2 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$9], ["styles", [_style_0$a]]]);
  ...
  const PagesTestTest3 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$8], ["styles", [_style_0$9]]]);
  ...
  const PagesTestTest4 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$7], ["styles", [_style_0$8]]]);
  ...
  const PagesTestTest5 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6], ["styles", [_style_0$7]]]);
    ...
    return vue.openBlock(), vue.createElementBlock("scroll-view", {
      ...
      vue.createElementVNode("view", { class: "section" }, [
        ...
        vue.createElementVNode("view", { class: "network-list" }, [
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($data.people, (person, index) => {
            return vue.openBlock(), vue.createElementBlock("view", {
              class: "network-item",
              key: index
            }, [
              ...
              vue.createElementVNode("view", { class: "person-info" }, [
                vue.createElementVNode("text", { class: "name" }, vue.toDisplayString(person.name), 1),
                vue.createElementVNode("text", { class: "tags" }, vue.toDisplayString(person.tags.join(" | ")), 1)
              ])
            ]);
          }), 128))
        ]),
  ...
  const PagesDashboardDashboard = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["styles", [_style_0$6]]]);
      ...
      vue.createElementVNode("view", { class: "card" }, [
        vue.createElementVNode("view", { class: "score-container" }, [
          ...
          vue.createElementVNode("view", { class: "score-details" }, [
            vue.createElementVNode("text", { class: "score-value-large" }, vue.toDisplayString($data.score), 1),
  ...
  const PagesDashboardDashboar1d = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["styles", [_style_0$5]]]);
  ...
  function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("scroll-view", {
      ...
      vue.createElementVNode("view", { class: "score-evaluation" }, [
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($data.scores, (item, indpowerex) => {
          return vue.openBlock(), vue.createElementBlock("view", {
            class: "score-item",
            key: _ctx.index
          }, [
            vue.createElementVNode("text", { class: "score-item-title" }, vue.toDisplayString(item.title), 1),
            vue.createElementVNode("text", { class: "score-item-value" }, vue.toDisplayString(item.value), 1),
            vue.createElementVNode("text", { class: "score-item-description" }, vue.toDisplayString(item.description), 1)
          ]);
        }), 128))
      ]),
  ...
  const PagesDetailsDetails = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["styles", [_style_0$4]]]);
  ...
  const PagesLoginLogin = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["styles", [_style_0$3]]]);
        ...
        vue.createElementVNode("view", { class: "content" }, [
          ...
          vue.createElementVNode("view", { class: "card" }, [
            vue.createElementVNode("view", { class: "score-container" }, [
              vue.createElementVNode("text", { class: "score-title" }, "\u60C5\u5546\u5C0F\u767D"),
              vue.createElementVNode("view", { class: "score-details" }, [
                vue.createElementVNode("text", { class: "score-value-large" }, vue.toDisplayString($data.homepageData.response.eq_scores.score), 1),
                vue.createElementVNode("text", { class: "score-value-small" }, "\u5206")
              ]),
              vue.createElementVNode("view", { class: "progress-bar" }, [
                vue.createElementVNode("view", {
            ...
            vue.createElementVNode("view", { class: "card-content" }, [
              vue.createElementVNode("view", { class: "card-text-container" }, [
                vue.createElementVNode("view", { class: "icon-text-box" }, [
                  vue.createElementVNode("view", { class: "text-box" }, [
                    vue.createElementVNode("text", { class: "card-title" }, vue.toDisplayString($data.homepageData.response.eq_scores.summary), 1)
                  ])
                ]),
                vue.createElementVNode("text", { class: "card-description" }, vue.toDisplayString($data.homepageData.response.eq_scores.overall_suggestion), 1)
              ])
            ])
          ]),
          vue.createElementVNode("view", { class: "card1" }, [
            ...
            vue.createElementVNode("view", { class: "card-content" }, [
              vue.createElementVNode("view", { class: "card-text-container" }, [
                ...
                vue.createElementVNode("text", { class: "card-description" }, vue.toDisplayString($data.homepageData.response.eq_scores.detail), 1)
              ])
            ])
          ]),
          vue.createElementVNode("view", { class: "card2" }, [
            ...
            vue.createElementVNode("view", { class: "score-container1" }, [
              ...
              vue.createElementVNode("text", { class: "score-title1" }, vue.toDisplayString($data.homepageData.response.eq_scores.dimension1_score) + "%", 1),
              vue.createElementVNode("text", { class: "card-description" }, vue.toDisplayString($data.homepageData.response.eq_scores.dimension1_detail), 1)
            ]),
            vue.createElementVNode("view", { class: "score-container1" }, [
              ...
              vue.createElementVNode("text", { class: "score-title1" }, vue.toDisplayString($data.homepageData.response.eq_scores.dimension2_score) + "%", 1),
              vue.createElementVNode("text", { class: "card-description" }, vue.toDisplayString($data.homepageData.response.eq_scores.dimension2_detail), 1)
            ]),
            vue.createElementVNode("view", { class: "score-container1" }, [
              ...
              vue.createElementVNode("text", { class: "score-title1" }, vue.toDisplayString($data.homepageData.response.eq_scores.dimension3_score) + "%", 1),
              vue.createElementVNode("text", { class: "card-description" }, vue.toDisplayString($data.homepageData.response.eq_scores.dimension3_detail), 1)
            ]),
            vue.createElementVNode("view", { class: "score-container1" }, [
              ...
              vue.createElementVNode("text", { class: "score-title1" }, vue.toDisplayString($data.homepageData.response.eq_scores.dimension4_score) + "%", 1),
              vue.createElementVNode("text", { class: "card-description" }, vue.toDisplayString($data.homepageData.response.eq_scores.dimension4_detail), 1)
            ]),
            vue.createElementVNode("view", { class: "score-container1" }, [
              ...
              vue.createElementVNode("text", { class: "score-title1" }, vue.toDisplayString($data.homepageData.response.eq_scores.dimension5_score) + "%", 1),
              vue.createElementVNode("text", { class: "card-description" }, vue.toDisplayString($data.homepageData.response.eq_scores.dimension5_detail), 1)
            ])
          ]),
          vue.createElementVNode("button", {
            class: "guide-button",
  ...
  const PagesResultResult = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["styles", [_style_0$2]]]);
  ...
  const _style_0$1 = {"container":{"":{"display":"flex","flexDirection":"column","backgroundColor":"#1c1c1e","position":"relative"}},"background-image":{"":{"position":"absolute","top":0,"left":0,"width":"100%","zIndex":1}},"content":{"":{"flex":1,"display":"flex","flexDirection":"column","justifyContent":"flex-start","paddingTop":20,"paddingRight":20,"paddingBottom":20,"paddingLeft":20,"zIndex":1,"position":"relative"}},"text-content":{"":{"marginBottom":"160rpx","marginTop":"120rpx"}},"greeting":{"":{"fontSize":"48rpx","color":"#ffffff","marginBottom":"20rpx"}},"question":{"":{"fontSize":"40rpx","color":"#ffffff","marginBottom":"10rpx"}},"subtitle":{"":{"fontSize":"28rpx","color":"#8e8e93"}},"name-input":{"":{"width":"100%","backgroundColor":"#2c2c2e","borderRadius":"20rpx","paddingTop":"20rpx","paddingRight":"30rpx","paddingBottom":"20rpx","paddingLeft":"30rpx","color":"#ffffff","fontSize":"32rpx","marginBottom":"140rpx"}},"button-container":{"":{"display":"flex","flexDirection":"column","alignItems":"center","marginTop":"auto","marginBottom":"1100rpx"}},"continue-button":{"":{"width":"100rpx","height":"100rpx","backgroundColor":"#8BC34A","borderRadius":"50rpx","display":"flex","justifyContent":"center","alignItems":"center"}},"arrow":{"":{"color":"#242424","fontSize":"40rpx"}}};
  ...
  const PagesExperienceExperience = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["styles", [_style_0$1]]]);
